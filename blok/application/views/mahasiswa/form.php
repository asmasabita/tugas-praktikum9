...
<form>
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="nama" name="nama" placeholder="Masukan nim" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    <label for="tgl_ahir" class="col-4 col-form-label">Tanggal Lahir</label> 
    <div class="col-8">
      <input id="tgl_ahir" name="tgl_ahir" type="text" class="form-control">
    </div>
  </div>
  <div class="form-group row">
